...
const HEADLINES_RSS = 'https://news.google.com.br/news/rss';
const TOPICS_RSS    = 'https://news.google.com.br/news/rss/headlines/section/topic/';
const GEO_RSS       = 'https://news.google.com.br/news/rss/headlines/section/geo/';
const SEARCH_RSS    = 'https://news.google.com.br/rss/search?q=';
...
const headlines = async ({country = 'br', language = 'pt-br', n = 10}={}) => {
...
const topic = async (topicName, {country = 'br', language = 'pt-br', n = 10}={}) => {
...
const geo = async (position, {country = 'br', language = 'pt-br', n = 10}={}) => {
  const url = GEO_RSS + encodeURIComponent(position) + '?' +
    fillCountryLangParams(country.toUpperCase(), language.toLowerCase());
  return (await getRss(url)).items.slice(0, Math.max(0, n));
};

const search = async (query, {country = 'br', language = 'pt-br', n = 10}={}) => {
